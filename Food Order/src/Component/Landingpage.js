...
const Landingpage=()=>
{
   ...
   <nav class="navbar">
          ...
          <ul class="nav-list">
           ...
           <a href="#restaurants"> <li className="rest"><PiBuildingsFill/>Restaurants</li></a>
           <Link to='/Aboutus'> <li className="about"><FaUser />About Us</li></Link>
        <Link to='/Privacy'>    <li className="contact"><MdPolicy /> Policies</li></Link>
           <a href="#contactus"> <li className="cart" style={{color:"black"}}><FaHeadphones/>Contact Us</li></a> 
          </ul>
  ...
  <footer id="contactus">
    <div class="content">
      ...
      <div class="link-boxes">
        <ul class="box">
          ...
          <Link to='/'><li className="hoverr"><a href="#">Home</a></li></Link>
        <Link to ='/Aboutus'>  <li className="hoverr"><a href="#">About Us</a></li></Link>
          <li className="hoverr"><a href="#restaurants">Restaurants</a></li>
         <Link to='/Privacy'> <li className="hoverr"><a href="#">Policies</a></li></Link>

        </ul>
        <ul class="box">
          {/* <li class="link_name">FAQ</li> */}
       <Link to='/Terms'>   <li className="link_name">Terms & Conditions</li></Link>
          <li className="hoverr"><a href="#">Govt</a></li>
          <Link to='/Privacy'>
          <li className="hoverr"><a href="#">Privacy Policies</a></li>
          </Link>
    ...
    <div class="bottom-details">
      <div class="bottom_text">
        <span class="copyright_text">Copyright © 2023 <a href="#">FoodRush.</a></span>
