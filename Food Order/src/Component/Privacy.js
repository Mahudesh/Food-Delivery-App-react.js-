...
function Privacy() {
  ...
  <article>
    ...
    <p>Like any other website,<span>Website Name</span> uses &lsquo;cookies&apos;. These cookies are used to store information including visitors&apos; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&apos; experience by customizing our web page content based on visitors&apos; browser type and/or other information.</p>
  ...
  <Link to='/Terms'>Terms and Conditions.</Link></label>
</div>
<br></br>
</main>
